...
else
{
	...
	<table class="filter_tab" style="margin:5px 0 0 0;">
		<tr>
			...
			<td colspan="2"><?=dll(array('remove'=>'-- все --','Звонок'=>'Звонок','Сообщение'=>'Сообщение'),'name="msg" onChange="RegSessionSort(\''.$script.'\',\'msg=\'+this.value);return false;"',$f_msg?$f_msg:'-- все --')?></tr>
		<tr>
